...
import org.statix.bukkit.utility.MetadataUtil;
import org.statix.bukkit.protocollib.packet.scoreboard.WrapperPlayServerScoreboardDisplayObjective;
import org.statix.bukkit.protocollib.packet.scoreboard.WrapperPlayServerScoreboardObjective;
...
public class BaseScoreboard {
    ...
    public void addScoreboardUpdater(@NonNull ScoreboardUpdater scoreboardUpdater,
        ...
        }.runTaskTimer(StatixAPI.getInstance().getPlugin(StatixAPI.class), durationTick, durationTick);
