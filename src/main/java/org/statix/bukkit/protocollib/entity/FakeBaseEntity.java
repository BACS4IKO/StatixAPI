...
import org.statix.bukkit.protocollib.packet.ProtocolPacketFactory;
import org.statix.bukkit.protocollib.packet.entity.*;
...
public abstract class FakeBaseEntity implements Cloneable, FakeEntity {
    ...
    @Setter @Getter protected boolean autoLooking;
    @Setter @Getter protected double autoLookingDistance;
    ...
    public FakeBaseEntity(@NonNull EntityType entityType, @NonNull Location location) {
        this(entityType, location, FakeEntityScope.PRIVATE);
    }

    @Override
    public synchronized void enableAutoLooking(double distance){
        this.autoLooking = true;
        this.autoLookingDistance = distance;
    }
    ...
    public synchronized void remove() {
        setEntityScope(FakeEntityScope.PRIVATE);
