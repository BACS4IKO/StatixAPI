...
import org.statix.base.utility.StringUtil;
...
public class ProtocolTeam {
    ...
    // вот сука так оно работает, а через substring нет
    // тут либо я криворукий, либо чет-тут не так
    // (c) ItzStatix
    public String fixLength(int length, String string){
