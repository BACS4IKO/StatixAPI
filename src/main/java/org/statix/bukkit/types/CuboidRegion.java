package org.statix.bukkit.types;
...
public class CuboidRegion implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public CuboidRegion(Map<String, Object> map) {
        ...
        this.pos1 = new Location(Bukkit.getWorld((String)this.worldName), (double)this.x1, (double)this.y1, (double)this.z1);
        this.pos2 = new Location(Bukkit.getWorld((String)this.worldName), (double)this.x2, (double)this.y2, (double)this.z2);
    }
