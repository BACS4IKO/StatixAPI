...
import ru.statix.api.bukkit.board.line.SidebarLine;
import ru.statix.api.bukkit.board.objective.SidebarObjective;
import ru.statix.api.bukkit.board.updater.SidebarUpdater;

import java.util.*;

public class StatixSidebar {
    ...
    @Getter
    private static final Map<String, StatixSidebar> playerSidebarsMap = new HashMap<>();
