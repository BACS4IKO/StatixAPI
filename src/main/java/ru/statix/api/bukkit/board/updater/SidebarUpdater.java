package ru.statix.api.bukkit.board.updater;
...
public class SidebarUpdater {
    ...
    private final Multimap<Long, Consumer<StatixSidebar>> tasks;
     ...
     */
    public SidebarUpdater(@NonNull StatixSidebar sidebar) {
     ...
     * @return список задач
     */
    public Multimap<Long, Consumer<StatixSidebar>> getTasks() {
     ...
     */
    public SidebarUpdater newTask(@NonNull Consumer<StatixSidebar> task, long delay) {
