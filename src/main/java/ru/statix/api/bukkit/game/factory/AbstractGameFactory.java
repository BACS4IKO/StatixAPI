package ru.statix.api.bukkit.game.factory;
...
import ru.statix.api.bukkit.game.enums.GameType;
...
//---------------------------------------------------------------//
    ...
    public AbstractGameFactory(@NonNull GameType gameType, int startSecondsTimer) {
        ...
        Bukkit.getPluginManager().registerEvents(this, StatixAPI.getPlugin(StatixAPI.class));
    }
