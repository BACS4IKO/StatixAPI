package ru.statix.api.bukkit.protocollib.entity.listener;
...
import ru.statix.api.bukkit.protocollib.entity.FakeEntityLiving;
import ru.statix.api.bukkit.protocollib.entity.FakeEntityRegistry;
import ru.statix.api.bukkit.protocollib.entity.FakeEntityScope;
...
public class FakeEntityListener extends PacketAdapter
    ...
    public FakeEntityListener() {
        super(StatixAPI.getInstance().getPlugin(StatixAPI.class),
