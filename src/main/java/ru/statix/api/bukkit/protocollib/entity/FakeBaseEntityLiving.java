...
@Getter
public abstract class FakeBaseEntityLiving extends FakeBaseEntity implements FakeEntityLiving {
    ...
    @Override
    public synchronized void playAnimationAll(@NonNull ru.statix.api.bukkit.protocollib.entity.FakeEntityAnimation fakeEntityAnimation) {
        for (Player player : getViewerCollection())
            playAnimation(fakeEntityAnimation, player);
    }

    @Override
    public synchronized void playAnimation(@NonNull ru.statix.api.bukkit.protocollib.entity.FakeEntityAnimation fakeEntityAnimation, @NonNull Player player) {
