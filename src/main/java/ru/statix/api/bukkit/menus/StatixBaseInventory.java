...
import ru.statix.api.bukkit.menus.interfaces.InventoryInfo;

import java.util.HashMap;
import java.util.Map;

@Getter
public abstract class StatixBaseInventory {
    ...
    @Getter
    private static final Map<String, StatixBaseInventory> inventories = new HashMap<>();

    public StatixBaseInventory(String title, int rows) {
