    ...
    public void onPluginMessageReceived(String channel, Player player1, byte[] bytes) {
        ...
        switch (subchannel) {
            ...
            case "InitInventory": {
                ...
                StatixAPI.getInventoryManager().cacheInventory(inventoryName, new StatixBaseInventory(inventoryTitle, inventoryRows) {
                    @Override
            ...
            case "SendButtons": {
                ...
                StatixBaseInventory inventory = StatixAPI.getInventoryManager().getCachedInventory(inventoryName);
