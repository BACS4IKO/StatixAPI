...
public final class HologramManager extends AbstractCacheManager<StatixHologram> {

    /**
     * Кеширование голограммы в мапу по ее имени.
     */
    public void cacheHologram(String hologramName, StatixHologram hologram) {
     ...
     */
    public StatixHologram getCachedHologram(String hologramName) {
     ...
     */
    public void createHologram(String hologramName, Location location, Applicable<StatixHologram> hologramApplicable) {
        StatixHologram hologram = createHologram(location);
     ...
     */
    public StatixHologram createHologram(Location location) {
        return new StatixHologramImpl(location);
    }


    @Getter
    public static class StatixHologramImpl implements StatixHologram {

        private Location location;

        public StatixHologramImpl(Location location) {
