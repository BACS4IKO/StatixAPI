...
@Getter
public abstract class BungeePagedStatixInventory extends BungeeStatixInventory {
     ...
     */
    public BungeePagedStatixInventory(String inventoryName, String inventoryTitle, int inventoryRows) {
     ...
     * @param inventoryRows  - Количество строк в инвентаре
     */
    private BungeePagedStatixInventory(int page, String inventoryName, String inventoryTitle, int inventoryRows) {
