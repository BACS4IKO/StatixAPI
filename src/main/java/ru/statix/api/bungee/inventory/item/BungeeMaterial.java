package ru.statix.api.bungee.inventory.item;
...
public enum BungeeMaterial {
    ...
    private static BungeeMaterial[] byId = new BungeeMaterial[383];
    ...
    static {
        ...
        for(int var1 = 0; var1 < var2; ++var1) {
            BungeeMaterial material = var3[var1];
    ...
    /** @deprecated */
    @Deprecated
    public static BungeeMaterial getBungeeMaterial(int id) {
        return byId.length > id && id >= 0 ? byId[id] : null;
    }

    public static BungeeMaterial getBungeeMaterial(String name) {
    ...
    public static BungeeMaterial matchBungeeMaterial(String name) {
        ...
        try {
            result = getBungeeMaterial(Integer.parseInt(name));
