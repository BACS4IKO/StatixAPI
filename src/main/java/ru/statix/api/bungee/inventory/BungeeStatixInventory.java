package ru.statix.api.bungee.inventory;
...
import ru.statix.api.bungee.BungeeStatixAPI;
import ru.statix.api.bungee.inventory.item.BungeeItemStack;
import ru.statix.api.bungee.utility.SpigotMessageUtil;
import ru.statix.api.bungee.inventory.interfaces.BungeeInventoryButton;
import ru.statix.api.bungee.inventory.item.BungeeItemMeta;
...
@Getter
public abstract class BungeeStatixInventory {
    ...
    public static final Map<ProxiedPlayer, BungeeStatixInventory> PLAYER_INVENTORY_MAP = new HashMap<>();
     ...
     */
    public BungeeStatixInventory(String inventoryName, String inventoryTitle, int inventoryRows) {
        this.inventoryName = inventoryName;
        this.inventoryTitle = inventoryTitle;
        this.inventoryRows = inventoryRows;
        this.inventorySize = inventoryRows * 9;

        BungeeStatixAPI.getInventoryManager().cacheInventory(inventoryName, this);
