...
import ru.statix.api.bungee.inventory.manager.BungeeInventoryManager;
import ru.statix.api.bungee.listeners.BungeeInventoryListener;
        ...
        SpigotMessageUtil.registerAcceptMessages(this, event -> {
            ...
            switch (subchannel) {
                ...
                case "InventoryCloseEvent": {
                    ...
                    BungeeStatixInventory inventory = inventoryManager.getInventory(inventoryName);
